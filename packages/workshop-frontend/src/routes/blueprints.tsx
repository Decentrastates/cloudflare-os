  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-4xl flex-col px-6 sm:px-10">
      ...
      <header className="min-w-0 px-3 pb-3 pt-10">
        <h1 className="text-2xl font-semibold tracking-tight text-kumo-default">{t("Blueprints")}</h1>
        <p className="mt-1 text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-subtle">
          {t("Reusable starting points you've published or saved. Spin up a workspace from any of them.")}</p>
      </header>
