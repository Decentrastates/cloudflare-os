...
export default function ResourceConfiguratorHost({
  ...
  if (disabled) return <Placeholder>{t("Choose an account before selecting a resource.")}</Placeholder>
  if (loading) return <Placeholder>{t("Loading configurator...")}</Placeholder>
