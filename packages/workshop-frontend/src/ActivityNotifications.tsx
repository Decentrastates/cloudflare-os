        ...
        render={
          <button
            ...
            aria-label={pending.length > 0
              ? t('Activity — {{count}} {{requestText}} review', {
                  count: pending.length,
                  requestText: pending.length === 1 ? t('request needs') : t('requests need'),
                })
              : t('Activity')}
          ...
          >
            <span>
              {pending.length > PREVIEW_LIMIT
                ? t('View all {{count}} requests', { count: pending.length })
                : t("View all activity")}
            </span>
