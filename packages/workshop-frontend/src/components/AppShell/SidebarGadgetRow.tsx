...
export default function SidebarGadgetRow({
  ...
  return (
    <Link
      ...
      title={collapsed ? gadget.title || t('Untitled workspace') : undefined}
    >
      <div
            ...
            <DropdownMenu>
              ...
              <DropdownMenu.Content className={MENU_CONTENT} style={MENU_POSITIONER_STYLE}>
                <DropdownMenu.Item
                  ...
                  className={MENU_ITEM}
                >
                  <Pencil size={13} className="mr-2" /> {t("Rename")}</DropdownMenu.Item>
                <DropdownMenu.Item
                ...
                <DropdownMenu.Item
                  ...
                  className={MENU_ITEM}
                >
                  <ShareNetwork size={13} className="mr-2" /> {t("Share")}</DropdownMenu.Item>
