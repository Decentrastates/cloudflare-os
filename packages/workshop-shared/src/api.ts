 ...
 */
export const DEFAULT_SITE_NAME = "Bug OS";
...
export type AdminSettingsView = {
  ...
  siteName: string;
  /** Custom deployment logo, or undefined to use the default Bug OS mark. */
...
export interface AdminApi {
   ...
   * image, or undefined after reset. Pass null to restore the default Bug OS mark. The
